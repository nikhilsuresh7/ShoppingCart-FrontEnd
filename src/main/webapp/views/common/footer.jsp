...
<!-- Footer Section Starts -->
				...
				<!-- Contact Us Starts -->
					<div class="col-md-4 col-xs-12 last">
						...
						<ul>
							<li>Beat Me</li>
							<li>
								38, 4th B Cross Rd, Koramangala Industrial Layout, Koramangala Koramangala, Bengaluru, Karnataka 560034

							</li>
							<li>
								Email: <a href="#">admin@beatme.com</a>
							</li>								
						</ul>
						<h4 class="lead">
							Tel: <span>0(123) 456-7890</span>
						</h4>
					</div>
				<!-- Contact Us Ends -->
			</div>
	...
	<!-- Copyright Area Starts -->
		...
		<!-- Container Starts -->
			...
			<!-- Starts -->
				<p class="pull-left">
					&copy; 2016 BeatMe. Designed By <a href="#">Nikhil Suresh</a>
				</p>
			<!-- Ends -->
<!-- 
